...
#echo "streka based" >> /scratch/projects/bbc/Project/zLi/Mutation/myanno_mutect.4.certain.genes.passed.combined.2.variant_function
while read line; do
...
#echo "$f" >> /scratch/projects/bbc/Project/zLi/Mutation/myanno_mutect.4.certain.genes.passed.combined.variant_function

#sample_name=`echo "$f" | awk -F"." '{print $1}'`

#echo "$fbname" >> /scratch/projects/bbc/Project/zLi/Mutation/myanno_mutect.4.certain.genes.passed.combined.2.variant_function
#echo "$fbname" >> /scratch/projects/bbc/Project/zLi/Mutation/myanno_mutect.4.certain.genes.passed.combined.2.variant_function
...
#cat /scratch/projects/bbc/Project/zLi/Mutation/"$fbname"/results/myanno_mutect.4.certain.genes.passed.variant_function >> /scratch/projects/bbc/Project/zLi/Mutation/myanno_mutect.4.certain.genes.passed.combined.2.variant_function

#cat /scratch/projects/bbc/Project/zLi/Mutation/"$fbname"/results/myanno_str_new.4.certain.genes.variant_function >> /scratch/projects/bbc/Project/zLi/Mutation/myanno_mutect.4.certain.genes.passed.combined.2.variant_function

awk -F"\t" -vCallType="streka" -vpair="$fbname" '{OFS="\t";print CallType,pair,$1,$2,$3,$4,$5,$6,$7,$8}' /scratch/projects/bbc/Project/zLi/Mutation/"$fbname"/results/myanno_mutect.4.certain.genes.passed.variant_function >> /scratch/projects/bbc/Project/zLi/Mutation/myanno_mutect.4.certain.genes.passed.combined.3.variant_function

awk -F"\t" -vCallType="streka" -vpair="$fbname" '{OFS="\t";print CallType,pair,$1,$2,$3,$4,$5,$6,$7,$8}' /scratch/projects/bbc/Project/zLi/Mutation/"$fbname"/results/myanno_str_new.4.certain.genes.variant_function
