...
#python /nethome/axy148/MACS/bin/macs2 callpeak -t /scratch/projects/bbc/BAM2BW/"2016-03-20-1-9_S7_"_bam_sorted_by_position.bam -c /scratch/projects/bbc/Project/Lluis/Alignment/2016-03-20-1-1_S5__BWA/2016-03-20-1-1_S5_.bam -f BAM -g mm -n "2016-03-20-1-9_S7_"_bam_mm --outdir "/scratch/projects/bbc/Peak_chip_seq/Peak_chip_broad" -B -q 0.01

#python /nethome/axy148/MACS/bin/macs2 callpeak -t /scratch/projects/bbc/BAM2BW/"2016-03-20-1-9_S7_"_bam_sorted_by_position.bam -f BAM -g mm -n "2016-03-20-1-9_S7_"_bam_mm_shift_75_2 --nomodel --shift=75 --extsize=150 --outdir "/scratch/projects/bbc/Peak_chip_seq/Peak_chip_broad" -B -q 0.1


python /nethome/axy148/MACS/bin/macs2 callpeak -t /scratch/projects/bbc/BAM2BW/"2016-03-20-1-9_S7_"_bam_sorted_by_position.bam -f BAM --broad -g mm --broad-cutoff 0.1 -n "2016-03-20-1-9_S7_"_bam_mm_shift_75_2 --nomodel --shift=75 --extsize=150 --outdir "/scratch/projects/bbc/Peak_chip_seq/Peak_chip_broad"
