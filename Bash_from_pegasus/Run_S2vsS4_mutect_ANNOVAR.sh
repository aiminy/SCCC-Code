...
/scratch/projects/bbc/NGS-tools/annovar/convert2annovar.pl -format vcf4old /scratch/projects/bbc/Project/zLi/Mutation/S2vsS4/results/mutect_output_cut_c3.vcf > /scratch/projects/bbc/Project/zLi/Mutation/S2vsS4/results/mutect_output_cut_c3_mutect.avinput

/scratch/projects/bbc/NGS-tools/annovar/annotate_variation.pl -out /scratch/projects/bbc/Project/zLi/Mutation/S2vsS4/results/myanno_mutect -build mm10 /scratch/projects/bbc/Project/zLi/Mutation/S2vsS4/results/mutect_output_cut_c3_mutect.avinput /scratch/projects/bbc/NGS-tools/annovar/mm10db/
