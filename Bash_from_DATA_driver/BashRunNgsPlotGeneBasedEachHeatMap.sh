...
#sh BashRunNgsPlotGeneBasedEachHeatMap.sh ./All_27_heatmap_2.txt
...
#ngs.plot.r -G mm10 -R tss -C Config_Heatmap_"$f1".txt -O heatmap_max_2_rm_"$f1"_5kb_4_18_2016 -L 5000 -RR 1 -CD 1 -CO "snow":"snow":"red2" -GO max -RB 0.05  

ngs.plot.r -G mm10 -R tss -C Config_Heatmap_"$f1".txt -O heatmap_max_rm_new_"$f1"_5kb_4_22_2016 -L 5000 -RR 30 -CD 1 -CO "snow":"snow":"red2" -GO max  

#ngs.plot.r -G mm10 -R tss -C Config_Heatmap_"$f1".txt -O heatmap_pca_"$f1"_5kb_4_18_2016 -L 5000 -RR 1 -CD 1 -CO "snow":"snow":"red2" -GO pca  

#replot.r heatmap -I heatmap_3_"$f1"_5kb_4_18_2016.zip -O  heatmap_3_"$f1"_5kb_4_18_2016_max -M max

#replot.r heatmap -I heatmap_3_"$f1"_5kb_4_18_2016.zip -O  heatmap_3_"$f1"_5kb_4_18_2016_mean -M mean

#replot.r heatmap -I heatmap_3_"$f1"_5kb_4_18_2016.zip -O  heatmap_3_"$f1"_5kb_4_18_2016_window -M window
